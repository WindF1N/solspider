...
GAS_CONFIG = {
    # 🔥 VIP сигналы - максимальный приоритет ($2 при курсе $140/SOL)
    'vip_signals': {
        'priority_fee_sol': 0.0143,  # ~$2.00
        'description': 'Максимальный газ для VIP сигналов - мгновенное подтверждение'
    },
...
AUTO_BUY_CONFIG = {
    ...
    'priority_fee': 0.0143  # 🔥 VIP ПРИОРИТЕТНАЯ КОМИССИЯ $2 (при курсе $140/SOL)
}
